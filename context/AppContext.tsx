...
import { Slider, AiStage, SliderSuggestion, TerraformConfig, TerraformTarget, ControlConfig, SoundConfig, Modulation, CameraData, ViewMode, ShipConfig, ShipModulation, FlightMode } from '../types';
...
export interface AppContextType {
  ...
  // Analog Input for Joysticks
  analogInputRef: MutableRefObject<{ left: { x: number, y: number }, right: { x: number, y: number } }>;
