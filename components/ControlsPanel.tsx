...
const ShipModulationRow: React.FC<{
    ...
    // Component preserved for type safety but not rendered in Drone Mode
    return null;
};
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                {cameraControlsEnabled && (
                    <ToggleSwitch
                        label="Show OSD (On Screen Display)"
                        description="Display telemetry data."
...
export const ControlsPanel: React.FC = () => {
  ...
  useEffect(() => {
    // When EDITMODE is off, we restrict access to complex tabs, but allow Sound.
    ...
    // Also redirect 'ship' tab if active, as it's disabled in Drone Mode
    if (activeTab === 'ship') {
        setActiveTab('sliders');
    }
  }, [EDITMODE, activeTab]);
    ...
    <>
      ...
      >
        ...
        <div className="flex-shrink-0 flex overflow-x-auto px-4 pt-2 gap-1 border-b border-gray-700 no-scrollbar">
            ...
            {/* Ship Tab Hidden for Drone Mode */}
